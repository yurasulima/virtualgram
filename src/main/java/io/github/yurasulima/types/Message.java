...
public final class Message extends Context {
    ...
    public static Message contextOnly(Update update, Bot bot) {
        return new Message(0L, null, null, 0L, null, null, null, null, null, null, null, update, bot);
    }

    public Message withContext(Update update, Bot bot) {
        return new Message(
